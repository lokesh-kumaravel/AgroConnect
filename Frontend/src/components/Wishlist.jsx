...
const Wishlist = () => {
  ...
  const toggleLike = async (productId) => {
    ...
    setWishlist((prevWishlist) =>
      prevWishlist.filter(
        (product) => product.id !== productId || newLikedState
      )
    );
  };
  ...
  const fetchImages = async (products) => {
    const updatedProducts = await Promise.all(
      products.map(async (product) => {
        try {
          const response = await axios.get(`/api/product/${product.id}/image`, {
            responseType: "blob",
          });
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <label
                          htmlFor={`like-${product.id}`}
                          style={{ width: "270%", height: "15px" }}
                        >
                          <svg
                              ...
                              <g id="right-hearts">
                                ...
                                >
                                  ...
                                  <path
                                    ...
                                    fill={
                                      likedProducts[product.id] ? "red" : "red"
                                    }
                                  />
                                  <path
                                    id="Path_11"
